  ...
  const renderContent = () => {
      ...
      return (
        <div className="space-y-8 text-text-secondary leading-relaxed font-light text-sm">
          ...
          <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">1. Information Collection and Use</h4>
          ...
          <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">2. Use of Data</h4>
          ...
          <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">3. Security of Data</h4>
            <p>The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
          </div>

           <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">4. Contact Us</h4>
    ...
    return (
      <div className="space-y-8 text-text-secondary leading-relaxed font-light text-sm">
         ...
         <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">1. Conditions of Use</h4>
          ...
          <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">2. Intellectual Property</h4>
          ...
          <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">3. Links To Other Web Sites</h4>
           ...
           <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">4. Disclaimer</h4>
            <p>Your use of the Service is at your sole risk. The Service is provided on an "AS IS" and "AS AVAILABLE" basis. The Service is provided without warranties of any kind, whether express or implied, including, but not limited to, implied warranties of merchantability, fitness for a particular purpose, non-infringement or course of performance.</p>
          </div>

          <div className="space-y-3">
            <h4 className="font-serif font-semibold text-lg text-text-highlight">5. Governing Law</h4>
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between p-8 border-b border-border bg-bg">
              <h2 className="font-serif font-semibold text-2xl text-text-highlight">{title}</h2>
              <button onClick={onClose} className="p-2 text-text-muted hover:text-text-highlight hover:bg-ink/5 rounded transition-colors">
                <X className="w-6 h-6" />
              </button>
            </div>
