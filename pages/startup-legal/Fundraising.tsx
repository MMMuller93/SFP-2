...
export const Fundraising: React.FC = () => {
  const services = [
    'SAFE and convertible note preparation',
    'Priced round documentation and term sheet review',
    'Due diligence organization and data room setup',
    'Corporate record cleanup and preparation',
    'Cap table audit and investor-ready formatting',
    'Certificate of Incorporation amendments',
    'Board and stockholder financing consents',
    'Side letter and investor document review'
  ];
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Get your company ready to raise capital with organized records and investor-ready documentation."
        ...
        <div className="px-8 md:px-16 lg:px-24 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-text-secondary font-light leading-relaxed max-w-3xl">
              Get your company ready to raise capital with organized records and investor-ready documentation.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-bg py-24 md:py-32">
        <div className="px-8 md:px-16 lg:px-24 max-w-4xl mx-auto text-center">
          ...
          <p className="text-text-secondary text-lg mb-12 font-light">
            Discuss your fundraising timeline and requirements.
          </p>
