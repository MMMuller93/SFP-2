...
export const Governance: React.FC = () => {
  const services = [
    ...
    'Bylaw amendments and committee formations',
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Ongoing corporate maintenance and board documentation for clean, investor-ready records."
        ...
        <div className="px-8 md:px-16 lg:px-24 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-text-secondary font-light leading-relaxed max-w-3xl">
              Ongoing corporate maintenance and board documentation for clean, investor-ready records.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-bg py-24 md:py-32">
        <div className="px-8 md:px-16 lg:px-24 max-w-4xl mx-auto text-center">
          ...
          <p className="text-text-secondary text-lg mb-12 font-light">
            Discuss your corporate governance and compliance requirements.
          </p>
