...
export const Equity: React.FC = () => {
  const services = [
    'Founder and employee stock issuances',
    'Stock option grants under equity plans',
    'Restricted stock awards with vesting',
    'Advisor equity grants and SAFE templates',
    'Stock repurchases and cancellations',
    'Option exercise processing and early exercise',
    'Cap table maintenance and auditing',
    '83(b) election preparation and filing',
    '409A valuation provider coordination',
    'QSBS qualification review and planning'
  ];

  return (
    <>
      <ServiceSchema
        name="Equity Issuances"
        description="Stock grants, option awards, and cap table management for founders, employees, and advisors."
        serviceType="Equity Management and Stock Option Services"
      />
        ...
        <div className="px-8 md:px-16 lg:px-24 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-text-secondary font-light leading-relaxed max-w-3xl">
              Stock grants, option awards, and cap table management for your team and advisors.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-bg py-24 md:py-32">
        <div className="px-8 md:px-16 lg:px-24 max-w-4xl mx-auto text-center">
          ...
          <p className="text-text-secondary text-lg mb-12 font-light">
            Discuss your equity structure and cap table needs.
          </p>
